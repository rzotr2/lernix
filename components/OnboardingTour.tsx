    ...
    <Transition show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex min-h-screen items-center justify-center">
          ...
          <div className="glass-surface-strong relative min-h-[250px] w-[400px] max-w-[calc(100%-2rem)] rounded-2xl p-4 sm:p-6">
            ...
            <div className="mt-2 flex justify-between items-center">
              <button
                ...
                className={`btn-ghost px-4 py-2 rounded-full ${currentStep === 0 ? 'invisible' : ''}`}
              >
                Previous
              </button>
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handleNext}
                  className="btn-primary ml-2 rounded-full px-4 py-2 text-white"
                >
